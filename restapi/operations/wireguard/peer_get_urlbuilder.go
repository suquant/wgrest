...
func (o *PeerGetURL) Build() (*url.URL, error) {
	...
	if dev != "" {
		...
		return nil, errors.New("dev is required on PeerGetURL")
	}
	...
	if peerID != "" {
		...
		return nil, errors.New("peerId is required on PeerGetURL")
	}
...
func (o *PeerGetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PeerGetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PeerGetURL")
	}

...
// DeviceGetParams contains all the bound params for the device get operation
...
func (o *DeviceGetParams) bindDev(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {

...
// DeviceDeleteParams contains all the bound params for the device delete operation
...
func (o *DeviceDeleteParams) bindDev(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
